...
def attack(char_name: str,
           char_class: str) -> str:
    dm: str = 'нанёс урон противнику равный'
    if char_class == 'warrior':
        return (f'{char_name} {dm} {5 + randint(3, 5)}')
    elif char_class == 'mage':
        return (f'{char_name} {dm} {5 + randint(5, 10)}')
    elif char_class == 'healer':
        return (f'{char_name} {dm} {5 + randint(-3, -1)}')
...
def special(char_name: str,
            char_class: str) -> str:
    sp = 'применил специальное умение'
    if char_class == 'warrior':
        return (f'{char_name} {sp}«Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (f'{char_name} {sp} «Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name} {sp} «Защита {10 + 30}»')
